 ...
 * @since  1.6
 */
class DuesControllerDue extends JControllerForm
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Set the model
		/** @var DuesModelDue $model */
		$model = $this->getModel('Due', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_dues&view=dues' . $this->getRedirectToListAppend(), false));
